// Problema 2.1.1: f(x) = x^2 - 3 no intervalo [1, 2], com erro = 1e-05
...
x=1:0.1:2      // define onde começa e termina o eixo das abscissas
y=x.^2-3     // função padrão
...
xtitle("Localização das raízes: gráfico de f(x) = x^2-3",...
...
deff('y = f(x)', 'y = x^2-3')           // definindo a função padrão
ak = 1.0                                    // limite infimo do intervvalo
bk = 2.0                                      // limite supremo do intervalo
...
deff('y = f(x)', 'y = x^2 - 3')                       // definindo a função 
deff('y = f1(x)', 'y = 2*x')                           // definindo a derivada (primeira) da função
old_x = 1.5                                            // condição inicial do problema (xk) dentro do intervalo [1, 2]
...
deff('y = f(x)', 'y = x^2 - 3')                       // definindo a função 
old_x0 = 1.0                                            // condição inicial do problema (xk - 1)
old_x1 = 2.0                                            // condição inicial do problema (xk)
